...
exports.Squirrel = exports.SwallowStrategyMode = exports.FailAction = exports.DataLevel = exports.each = void 0;
...
exports.each = function (list, hander) {
...
(function (DataLevel) {
    ...
    DataLevel["high"] = "high";
})(DataLevel = exports.DataLevel || (exports.DataLevel = {}));
var FailAction;
(function (FailAction) {
    FailAction["recovery"] = "recovery";
    FailAction["stuff"] = "stuff";
    FailAction["discard"] = "discard";
})(FailAction = exports.FailAction || (exports.FailAction = {}));
var SwallowStrategyMode;
...
})(SwallowStrategyMode = exports.SwallowStrategyMode || (exports.SwallowStrategyMode = {}));
...
var intervalSwallow = function (squirrel, time) {
    ...
    exports.each(DataLevel, function (val, prop) {
...
var merge = function (target) {
    ...
    exports.each(sourceList, function (item) {
        exports.each(item, function (val, prop) {
...
var Squirrel = /** @class */ (function () {
    function Squirrel(options) {
        ...
        exports.each(DataLevel, function (value, prop) {
    ...
    Squirrel.prototype.setOptions = function (options) {
        ...
        if (newStrategy !== oldStrategy) {
            ...
            // 处理定时器类型的上报策略
            this.intervalTimer &&
                exports.each(this.intervalTimer, function (item) {
                    clearInterval(item);
                });
            delete this.intervalTimer;
            var spec = this.getStrategySpec();
            spec.intervalTimeValues &&
                exports.each(spec.intervalTimeValues, function (time) {
    ...
    Squirrel.prototype.getStrategySpec = function () {
        ...
        var loop = function (strategy, level) {
            if (strategy) {
                if (isArray(strategy)) {
                    exports.each(strategy, function (val, index) {
                        loop(val, level);
                    });
                }
                            ...
                            case SwallowStrategyMode.eventCount:
                                {
                                    if (isArray(strategy.value)) {
                                        exports.each(strategy.value, function (item) {
    ...
    Squirrel.prototype.destory = function () {
        ...
        delete this.intervalTimer;
        exports.each(this.delayTimer, function (value) {
            clearTimeout(value);
        });
        this.snapshot();
    };
    ...
    Squirrel.prototype.getLevalDataList = function (level, remove) {
        ...
        var list = [];
        if (level) {
            exports.each(this.pocket[level], function (data, index) {
                if (isValidData(data)) {
                    list.push({
                        data: data,
                        level: level,
            ...
            exports.each(this.pocket, function (value, prop) {
                exports.each(value, function (data, index) {
                    if (isValidData(data)) {
                        list.push({
                            data: data,
